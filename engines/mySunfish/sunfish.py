...
version = "sunfish 2023 modified by Björn Steiner (timed logic + adjusted piece values)"
...
class Position(namedtuple("Position", "board score wc bc ep kp")):
    ...
    wc -- the castling rights, [west/queen side, east/king side](wl,ws)
    bc -- the opponent castling rights, [west/king side, east/queen side](bl,bs)
...
class Searcher:
    ...
    def bound(self, pos, gamma, depth, can_null=True):
        ...
        if can_null and depth > 0 and self.history.count(pos)>1:
            return -pos.score
